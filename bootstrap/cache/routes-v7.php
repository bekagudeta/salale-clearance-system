...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::BOhLMQsvDG0lcRdM',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::d2YRejCsHeex6Hcu',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::2N7loihIVnLmQz3g',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/re(?|set\\-password/([^/]++)(*:35)|gistrar/(?|c(?|learance/([^/]++)(?|(*:77)|/(?|finalize(*:96)|reopen(*:109)|print(*:122)))|ertificates/([^/]++)/(?|regenerate(*:166)|download(*:182)))|reports/(?|export/([^/]++)(*:218)|download/([^/]++)(*:243)|faculty\\-report/([^/]++)(*:275))|verify/([^/]++)(*:299)))|/st(?|udent/(?|clearance/(?|([^/]++)(*:345)|history(*:360)|([^/]++)/cancel(*:383))|notifications/([^/]++)(?|/read(*:422)|(*:430)))|orage/(.*)(?|(*:453)))|/department/(?|approvals/([^/]++)/(?|approve(*:507)|reject(*:521))|history/([^/]++)(*:546))|/admin/(?|users/(?|([^/]++)(?|/edit(*:590)|(*:598))|bulk\\-delete(*:619)|([^/]++)/impersonate(*:647)|stop\\-impersonation(*:674)|export(*:688))|roles/(?|([^/]++)(?|(*:717))|permissions(?|(*:740)|/([^/]++)(*:757))|([^/]++)/assign\\-permissions(*:794))|departments/(?|([^/]++)(?|/edit(*:834)|(*:842))|reorder(*:858)|([^/]++)/(?|toggle\\-status(*:892)|assign\\-officer(*:915)))|settings/backup/d(?|ownload/([^/]++)(*:961)|elete/([^/]++)(*:983))|logs/(?|([^/]++)(*:1008)|clear(*:1022)|export(*:1037)))|/(.*)(*:1053))/?$}sDu',
    ),
    3 => 
    array (
      35 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::RSSXD4O3DWvpaZjj',
          ),
          1 => 
          array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:854:"function () {
                ...
                }";s:5:"scope";s:54:"Illuminate\\Foundation\\Configuration\\ApplicationBuilder";s:4:"this";N;s:4:"self";s:32:"00000000000003c70000000000000000";}}',
        'as' => 'generated::BOhLMQsvDG0lcRdM',
      ),
      'fallback' => false,
      'defaults' => 
      array (
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000003c90000000000000000";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'generated::RSSXD4O3DWvpaZjj',
      ),
      'fallback' => true,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:69:"C:\\xampp\\htdocs\\dashboard\\salale-clearance-system\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:323:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"000000000000042f0000000000000000";}}',
        'as' => 'storage.local',
      ),
      'fallback' => false,
      'defaults' => 
