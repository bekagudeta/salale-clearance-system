            ...
            <form action="{{ route('admin.users.store') }}" method="POST" id="createUserForm" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" class="form-input w-full px-4 py-2 @error('name') border-red-500 @enderror" required>
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" class="form-input w-full px-4 py-2 @error('email') border-red-500 @enderror" required>
                            @error('email')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="flex gap-2 items-center">
                                <input type="password" name="password" class="form-input flex-1 px-4 py-2 @error('password') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" class="form-input w-full px-4 py-2" required>
                        </div>
                    </div>
                </div>
                ...
                <div id="studentFields" style="display: none;">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <input type="text" name="student_id" value="{{ old('student_id') }}" class="form-input w-full px-4 py-2 @error('student_id') border-red-500 @enderror">
                            @error('student_id')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="faculty" value="{{ old('faculty') }}" class="form-input w-full px-4 py-2 @error('faculty') border-red-500 @enderror">
                            @error('faculty')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="department" value="{{ old('department') }}" class="form-input w-full px-4 py-2 @error('department') border-red-500 @enderror">
                            @error('department')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" value="{{ old('phone') }}" class="form-input w-full px-4 py-2 @error('phone') border-red-500 @enderror">
                            @error('phone')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div id="officerFields" style="display: none;" class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Department</label>
                            <select name="department_id" id="departmentSelect" class="form-input w-full px-4 py-2 @error('department_id') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="position" value="{{ old('position', 'staff') }}" class="form-input w-full px-4 py-2 @error('position') border-red-500 @enderror" placeholder="e.g. Head, Staff, Assistant">
                            @error('position')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
