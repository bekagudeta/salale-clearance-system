        ...
        <form action="{{ route('admin.departments.store') }}" method="POST" class="space-y-6" id="departmentForm">
            ...
            <div class="grid gap-6 lg:grid-cols-2">
                <div>
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name') }}" required class="form-input w-full px-4 py-3 @error('name') border-red-500 @enderror">
                    @error('name')
                ...
                <div>
                    ...
                    <input id="slug" name="slug" type="text" value="{{ old('slug') }}" required class="form-input w-full px-4 py-3 @error('slug') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input id="priority_order" name="priority_order" type="number" min="1" value="{{ old('priority_order', 1) }}" class="form-input w-full px-4 py-3 @error('priority_order') border-red-500 @enderror">
